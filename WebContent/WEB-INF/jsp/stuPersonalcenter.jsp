	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				...
				<form action="insertrenzheng" enctype="multipart/form-data" method="POST">
				<h4 class="modal-title" id="myModalLabel">
					模态框（Modal）标题
					<table>
             ...
             <td><input type="text" name="schoolname">
					    ...
					    <tr>
             <td>学生证封面：</td>
             <td><input type="file" name="fileimg1" id="fileimg">
             <span class="s1" id="img_msg"></span>
             </td>
            </tr>
            				    <tr>
             <td>学生证内页1：</td>
             <td><input type="file" name="fileimg2" id="fileimg">
             <span class="s1" id="img_msg"></span>
             </td>
            </tr>
            				    <tr>
             <td>学生证内页2：</td>
             <td><input type="file" name="fileimg3" id="fileimg">
             <span class="s1" id="img_msg"></span>
             </td>
            </tr>
